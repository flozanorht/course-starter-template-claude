...
Example use of hyperlink to external website with https://docs.asciidoctor.org/asciidoc/latest/[click here^] option.
...
----
image::sample-image.png[title="caption and alt text"]
----
